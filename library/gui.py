...
from library.book import add_book, load_books_object, edit_book, remove_book
from library.exceptions import InvalidPhoneNumber
from library.library_db import Book, Reader
from library.reader import load_readers_object, add_reader, edit_reader, remove_reader
...
class BookList(BoxLayout):
    def __init__(self, switch_layout_callback, **kwargs):
        ...
        columns_layout = BoxLayout(orientation="horizontal", size_hint=(1, 0.9))
